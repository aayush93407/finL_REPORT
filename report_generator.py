...
def generate_combined_report(combined_results):
    ...
    for url_result in combined_results['detailed_results']:
        ...
        url_details = [
            ...
            ["High Severity Vulnerabilities:", str(url_result['vulnerability_counts']['High'])],
            ["Medium Severity Vulnerabilities:", str(url_result['vulnerability_counts']['Medium'])],
            ["Low Severity Vulnerabilities:", str(url_result['vulnerability_counts']['Low'])]
        ]
